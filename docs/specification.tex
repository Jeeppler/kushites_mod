...
\begin{itemize}
	\item Temple
	\item Civic Center
	\item Storehouse (3-D model in review)
	\item House \checkmark
	\item Blacksmith $\rightarrow$ TODO Sketch
	\item Field
	\item Farmstead (3-D model in review)
	\item Corral
	\item Market $\rightarrow$ TODO Sketch
	\item Dock
	\item Barracks (3-D model in review)
	\item Fortress
...
The market place should be a colorful and chaotic collection of stalls on a square mud brick foundation. The color comes from the many goods (fruits, vegetable and spcies) merchants on the market are offerin
...
\subsection{Cavalry Placeholder}

\paragraph{Phase:} Village\\

\subsection{Nubian Spearman}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{img/nubian_spearman/Kushitespearman}
	\caption{Nubian Spearman}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{img/meroitic_pikeman/Meroitic_Pikeman}
	\caption{Meroitic Pikeman, by Malcolm Kwadwo Kwarte Quartey (Sundiata) [Licensed \href{https://creativecommons.org/licenses/by-sa/3.0/}{CC BY-SA 3.0}]}
\end{figure}  
...
\subsection{Meroitic Noble Archer}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{img/nubian_bowmen/nubien_bowmen}
